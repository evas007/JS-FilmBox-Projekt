...
filmy.unshift(
	{
		...
		nazev: 'Známí neznámí',
		plakat: {
			url: 'https://image.pmgstatic.com/cache/resized/w663/files/images/film/posters/164/833/164833135_38ae99.jpg',
			sirka: 663,
			vyska: 938,
		},
		ochutnavka: 'Hořkosladká komedie o partě českých a slovenských přátel, kteří se sejdou v pražském bytě, aby oslavili příchod Nového roku.',
		popis:
	...
	{
		id: 'hledej-zenu',
		nazev: 'Za vším hledej ženu',
		plakat: {
			url: 'https://image.pmgstatic.com/cache/resized/w663/files/images/film/posters/166/648/166648038_1fbf5f.jpg',
			sirka: 663,
			vyska: 938,
		},
		ochutnavka: 'Komedie - tři kamarádky, tři osudy, tři naprosto jiné příběhy a jiný pohled na život.',
		popis:
			'Tři kamarádky, tři osudy. Krásná Alex, sympatická Marta a svéhlavá Irena. Tři naprosto jiné příběhy a jiný pohled na život. Přesto je mezi nimi to nejpevnější pouto, které nic nemůže přetrhnout. Ani muž. Každá z nich má sen. Irena touží po vlastním domě a tomu podřizuje vše. Marta touží po moderování v rádiu, ale je lékárnice, která si strašně moc chce povídat s lidmi. A Alex? Ta neprožívá zrovna šťastné období s přítelem. Chtěla by normální vztah s bezva mužským... Jenže se bezhlavě a vášnivě zamiluje do o dost staršího, avšak velice charismatického šéfa velké nadnárodní firmy. Podlehne jeho šarmu, ovšem brzy narazí na jeho tvrdou slupku. V tu chvíli přicházejí na pomoc kamarádky a vymyslí na Alberta past, do které se postupně chytá… ovšem osud si občas se vztahy zahrává a přináší překvapení. Když příběh spěje k happy endu, zasáhne osud... Osobitá vztahová komedie, která nabízí velké herecké příležitosti pro tři skvělé herečky, a také mnoho slovního i situačního humoru. (Bio Illusion)',
		premiera: '2022-10-20',
	},
)
